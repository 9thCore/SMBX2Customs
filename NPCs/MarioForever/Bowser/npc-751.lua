...
local sampleNPCSettings = {
	...
	["movement.jump.time.length"] = 128, -- Movement Settings/Jump Settings/Cooldown/Range Length
	...
	["attack.timing.cooldown.length"] = 128, -- Attack Settings/Timing/Cooldown/Range Length
